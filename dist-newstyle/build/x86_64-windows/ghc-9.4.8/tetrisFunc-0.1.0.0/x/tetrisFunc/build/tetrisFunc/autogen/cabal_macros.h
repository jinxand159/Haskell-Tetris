...
/* package tetrisFunc-0.1.0.0 */
#ifndef VERSION_tetrisFunc
#define VERSION_tetrisFunc "0.1.0.0"
#endif /* VERSION_tetrisFunc */
#ifndef MIN_VERSION_tetrisFunc
#define MIN_VERSION_tetrisFunc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_tetrisFunc */
...
#define CURRENT_COMPONENT_ID "tetrisFunc-0.1.0.0-inplace-tetrisFunc"
